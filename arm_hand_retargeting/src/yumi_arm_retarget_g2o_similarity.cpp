...
int main(int argc, char *argv[])
{
 ...
 // Variables' bounds
  ...
  unsigned int q_trk_per_iterations = 50;//300;//10;//20; //50;
  ...
  double K_WRIST_POS_MAX = 50.0;//100.0;//20.0;//10.0;
  double K_ELBOW_POS_MAX = 50.0;//100.0;//20.0;//10.0;
  double K_WRIST_ORI_MAX = 50.0;//100.0;
