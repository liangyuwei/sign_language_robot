 ...
 */
std::vector<Eigen::Matrix<double, JOINT_DOF, 1>> MyUnaryConstraints::resolve_path_collisions(std::vector<Eigen::Matrix<double, JOINT_DOF, 1>> q_cur, unsigned int num_intervals)
{
  // Prep
 ...
 */
Eigen::Matrix<double, JOINT_DOF, 1> MyUnaryConstraints::resolve_point_collisions(Eigen::Matrix<double, JOINT_DOF, 1> x0, Eigen::Matrix<double, JOINT_DOF, 1> x1, double col_eps, unsigned int num_intervals)
{
  // Prep
  double e_cur;
 ...
 */
double MyUnaryConstraints::dense_collision_checking(Eigen::Matrix<double, JOINT_DOF, 1> x0, Eigen::Matrix<double, JOINT_DOF, 1> x1, Eigen::Matrix<double, JOINT_DOF, 1> &x_col, unsigned int num_intervals)
{
  // Prep
