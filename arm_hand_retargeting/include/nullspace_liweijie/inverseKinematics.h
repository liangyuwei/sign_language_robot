...
namespace inverseKinematics{
    void calculate_jacobian(const Eigen::Matrix<double,NUM_OF_JOINTS,1> joint_angle, 
            ...
            Eigen::AngleAxis<double> left_rv1(joint_angle[0],Eigen::Matrix<double,3,1>(double(0),double(0),double(1)));  Eigen::Matrix<double,3,3> Rq_l1 = left_rv1.toRotationMatrix(); 
            Eigen::AngleAxis<double> left_rv2(joint_angle[1],Eigen::Matrix<double,3,1>(double(0),double(0),double(1)));  Eigen::Matrix<double,3,3> Rq_l2 = left_rv2.toRotationMatrix();
            Eigen::AngleAxis<double> left_rv3(joint_angle[2],Eigen::Matrix<double,3,1>(double(0),double(0),double(1)));  Eigen::Matrix<double,3,3> Rq_l3 = left_rv3.toRotationMatrix();
            Eigen::AngleAxis<double> left_rv4(joint_angle[3],Eigen::Matrix<double,3,1>(double(0),double(0),double(1)));  Eigen::Matrix<double,3,3> Rq_l4 = left_rv4.toRotationMatrix();
            Eigen::AngleAxis<double> left_rv5(joint_angle[4],Eigen::Matrix<double,3,1>(double(0),double(0),double(1)));  Eigen::Matrix<double,3,3> Rq_l5 = left_rv5.toRotationMatrix();
            Eigen::AngleAxis<double> left_rv6(joint_angle[5],Eigen::Matrix<double,3,1>(double(0),double(0),double(1)));  Eigen::Matrix<double,3,3> Rq_l6 = left_rv6.toRotationMatrix();
            Eigen::AngleAxis<double> left_rv7(joint_angle[6],Eigen::Matrix<double,3,1>(double(0),double(0),double(1)));  Eigen::Matrix<double,3,3> Rq_l7 = left_rv7.toRotationMatrix();
            Eigen::AngleAxis<double> right_rv1(joint_angle[7],Eigen::Matrix<double,3,1>(double(0),double(0),double(1)));  Eigen::Matrix<double,3,3> Rq_r1 = right_rv1.toRotationMatrix();
            Eigen::AngleAxis<double> right_rv2(joint_angle[8],Eigen::Matrix<double,3,1>(double(0),double(0),double(1)));  Eigen::Matrix<double,3,3> Rq_r2 = right_rv2.toRotationMatrix();
            Eigen::AngleAxis<double> right_rv3(joint_angle[9],Eigen::Matrix<double,3,1>(double(0),double(0),double(1)));  Eigen::Matrix<double,3,3> Rq_r3 = right_rv3.toRotationMatrix();
            Eigen::AngleAxis<double> right_rv4(joint_angle[10],Eigen::Matrix<double,3,1>(double(0),double(0),double(1)));  Eigen::Matrix<double,3,3> Rq_r4 = right_rv4.toRotationMatrix();
            Eigen::AngleAxis<double> right_rv5(joint_angle[11],Eigen::Matrix<double,3,1>(double(0),double(0),double(1)));  Eigen::Matrix<double,3,3> Rq_r5 = right_rv5.toRotationMatrix();
            Eigen::AngleAxis<double> right_rv6(joint_angle[12],Eigen::Matrix<double,3,1>(double(0),double(0),double(1)));  Eigen::Matrix<double,3,3> Rq_r6 = right_rv6.toRotationMatrix();
            Eigen::AngleAxis<double> right_rv7(joint_angle[13],Eigen::Matrix<double,3,1>(double(0),double(0),double(1)));  Eigen::Matrix<double,3,3> Rq_r7 = right_rv7.toRotationMatrix();
    ...
    Eigen::MatrixXd plus_inverse(Eigen::MatrixXd J) {
    ...
    void calculate_dx(Eigen::Matrix<double,WRIST_DOF,1> &dx, const Eigen::Matrix<double,WRIST_DOF,1> x0, const Eigen::Matrix<double,WRIST_DOF,1> x1) {
        dx.block(0,0,3,1) = (x1-x0).block(0,0,3,1);
        // cout<<"dx: "<<(x1-x0).block(0,0,3,1).transpose()<<endl;
        Eigen::Vector3d ea0 = x0.block(3,0,3,1);
        Eigen::Vector3d ea1 = x1.block(3,0,3,1);
        // Eigen::Matrix3d drot = euler2rotmat(ea0).transpose()*euler2rotmat(ea1);
        Eigen::Matrix3d drot = euler2rotmat(ea1)*euler2rotmat(ea0).transpose()- Eigen::Matrix3d::Identity();
        // Calculate dtheta
