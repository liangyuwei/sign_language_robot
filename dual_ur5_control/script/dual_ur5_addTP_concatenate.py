...
# Input: new Cartesian paths
# Output: concatenated joint trajectories
...
#    self.scene.add_mesh(mesh_name, pose, file_path, size)
  ...
  def path_eef_to_joint(self, x_start, w_start, x_mid, w_mid, x_final, w_final, planning_time, left_or_right_eef):

    # This function loads a Cartesian path and computes the corresponding joint path using TRAC_IK.
