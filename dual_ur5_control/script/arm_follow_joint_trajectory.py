...
if __name__ == '__main__':
    ...
    gripper_joints =  ['left_rh_p12_rn', 'left_rh_r2', 'left_rh_l1', 'left_rh_l2']


    # Connect to the right arm trajectory action server
    print "Connecting to the left gripper trajectory action server..."
    gripper_client = actionlib.SimpleActionClient('/dual_ur5_arm/left_gripper_controller/follow_joint_trajectory', FollowJointTrajectoryAction)
