...
int main(int argc, char** argv)
{
  ...
  original_pub_ = n_.advertise<arm_hand_capture::DualArmDualHandStateWithImage>("/dual_arms_dual_hands_state_with_image_before_transform", 100);
  ros::Publisher adjusted_pub_;
  adjusted_pub_ = n_.advertise<arm_hand_capture::DualArmDualHandStateWithImage>("/dual_arms_dual_hands_state_with_image_after_transform", 100);
  ...
  std::cout << "The input h5 file to load pos and ori of movement before transform is: " << original_in_file_name << std::endl;
  std::cout << "The input h5 file to load pos and ori of movement after transform is: " << adjusted_in_file_name << std::endl;
  ...
  std::vector<std::vector<double> > l_shoulder_quat_human = read_h5(original_in_file_name, in_group_name, "l_up_quat");
  std::vector<std::vector<double> > r_shoulder_quat_human = read_h5(original_in_file_name, in_group_name, "r_up_quat");
  std::vector<std::vector<double> > l_elbow_quat_human = read_h5(original_in_file_name, in_group_name, "l_fr_quat");
  std::vector<std::vector<double> > r_elbow_quat_human = read_h5(original_in_file_name, in_group_name, "r_fr_quat");  
  std::vector<std::vector<double> > l_wrist_quat_human = read_h5(original_in_file_name, in_group_name, "l_hd_quat");
  std::vector<std::vector<double> > r_wrist_quat_human = read_h5(original_in_file_name, in_group_name, "r_hd_quat"); // quaternion is (x,y,z,w)


  std::vector<std::vector<double> > l_shoulder_quat_robot = read_h5(original_in_file_name, in_group_name, "l_up_quat");
  std::vector<std::vector<double> > r_shoulder_quat_robot = read_h5(original_in_file_name, in_group_name, "r_up_quat");
  std::vector<std::vector<double> > l_elbow_quat_robot = read_h5(original_in_file_name, in_group_name, "l_fr_quat");
  std::vector<std::vector<double> > r_elbow_quat_robot = read_h5(original_in_file_name, in_group_name, "r_fr_quat");  
  std::vector<std::vector<double> > l_wrist_quat_robot = read_h5(original_in_file_name, in_group_name, "l_hd_quat");
  std::vector<std::vector<double> > r_wrist_quat_robot = read_h5(original_in_file_name, in_group_name, "r_hd_quat"); // quaternion is (x,y,z,w)
  ...
  {
    // Get messages
    arm_hand_capture::DualArmDualHandStateWithImage original_state_msg = construct_state_msg(r_shoulder_pos_human[n], r_shoulder_quat_human[n],
                                                                           r_elbow_pos_human[n], r_elbow_quat_human[n],
                                                                           r_wrist_pos_human[n], r_wrist_quat_human[n],
                                                                           l_shoulder_pos_human[n], l_shoulder_quat_human[n],
                                                                           l_elbow_pos_human[n], l_elbow_quat_human[n],
                                                                           l_wrist_pos_human[n], l_wrist_quat_human[n]);


    arm_hand_capture::DualArmDualHandStateWithImage adjusted_state_msg = construct_state_msg(r_shoulder_pos_adjusted[n], r_shoulder_quat_robot[n],
                                                                           r_elbow_pos_adjusted[n], r_elbow_quat_robot[n],
                                                                           r_wrist_pos_adjusted[n], r_wrist_quat_robot[n],
                                                                           l_shoulder_pos_adjusted[n], l_shoulder_quat_robot[n],
                                                                           l_elbow_pos_adjusted[n], l_elbow_quat_robot[n],
                                                                           l_wrist_pos_adjusted[n], l_wrist_quat_robot[n]);
    // Publish states
