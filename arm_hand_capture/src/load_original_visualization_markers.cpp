...
void GetPosAndVisualize::posCallback(const arm_hand_capture::DualArmDualHandStateWithImageConstPtr& msg)
{
  ...
  marker.ns = "original_movement"; // namespace?
  ...
  // Draw hands
  double human_hand_length = 0.12; // my data, by LYW 2020/07/21
...
GetPosAndVisualize::GetPosAndVisualize()
{
  ...
  pos_sub_ = n_.subscribe<arm_hand_capture::DualArmDualHandStateWithImage>("/dual_arms_dual_hands_state_with_image_original_movement", 100, boost::bind(&GetPosAndVisualize::posCallback, this, _1));
