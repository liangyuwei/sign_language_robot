...
int main(int argc, char** argv){
  ...
  ros::NodeHandle n;
  ROS_INFO_STREAM("Waiting for /dual_arms_dual_hands_state_with_image to come up...");
  ros::Subscriber sub = n.subscribe("/dual_arms_dual_hands_state_with_image", 100, &poseCallback);
